        ...
        <div class="container">
            <div class="main-blog-wrap">
                ...
                <div class="main-blog-left">
                    <h3 class="related-title">Dự án của chúng tôi</h3>
                        ...
                        @foreach ($duan as $item)
                            ...
                            <div class="article-item " data-index="">
                                <div class="article-item-wrap">
                                    <a href= "{{ route('duanTieuBieuDetail', $item->slug) }}" class="article-item-image"
                                       title="{{ $item->name }}">
                                        <img loading="lazy" decoding="async" width="600" height="400"
                                             src="{{ isset($img[0]) ? $img[0] : url('frontend/img/default.jpg') }}"
                                             alt="{{ $item->name }}" title="{{ $item->name }}">
                                    </a>
                                    <div class="article-item-detail">
                                        <h3 class="article-item-detail-title"><a title="{{ $item->name }}" href="{{ route('duanTieuBieuDetail', $item->slug) }}">{{ $item->name }}</a></h3>
                                        ...
                                        <a title="Xem thêm" href="{{ route('duanTieuBieuDetail', $item->slug) }}" class="article-item-detail-more" >Xem thêm</a>
                    ...
                    {{ $duan->links('layouts.pagination.paginate') }}
