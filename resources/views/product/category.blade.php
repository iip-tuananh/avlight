        ...
        <div title="Tất cả sản phẩm" class="main-collection-breadcrumb">
            <div class="container">
                ...
                <div class="breadcrumb-wrap">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}" aria-label="Trang chủ"
                ...
                @foreach ($productCategories as $productType)
                    @if ($productType->products->count())
                        <section class="home-product-new section-distance container">
                            <div
                                class="d-flex-vertical d-flex-center layout-gap-0.5unit home-product-header home-custom-header">
                                <h2 class="m-reset f-size-5 f-superbold limit-line threeline f-center text-primary-color">
                                    {{ languageName($productType->name) }}</h2>
                                <div class="home-custom-header-flex d-flex-vertical d-flex-center">
                                    ...
                                    @else
                                        <a style='color: #333333'
                                            class="m-reset f-size-3 limit-line fiveline f-center home-custom-extra-header"
                                            href="{{ route('allListType', ['danhmuc' => $productType->cate_slug, 'loaidanhmuc' => $productType->slug]) }}"
                                            title="Xem tất cả">Xem tất cả</a>
                                    @endif
                                </div>
                            </div>
