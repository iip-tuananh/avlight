...
@section('content')
                ...
                @foreach ($banner as $item)
                    <div class="home-slider-item">
                        <a href="" aria-label="" title="">
                            <picture>
                                <source width="1920" height="1080" media="(min-width: 800px)"
                                    srcset="{{ $item->image }}">
                                <source width="800" height="800" media="(min-width: 0)" srcset="{{ $item->image }}">
                                <img loading="eager" decoding="sync" fetchpriority="high" width="1920" height="1080"
    ...
    <style>
        ...
        * {
        ...
        /* Hover effect nhẹ */
        .about-images:hover .img-circle-1 {
            transform: translate(-10px, -10px) scale(1.05);
        }

        .about-images:hover .img-circle-2 {
            transform: translate(10px, 10px) scale(1.05);
        }

        .about-images:hover .img-circle-3 {
            transform: translate(-10px, 10px) scale(1.05);
        }

        .about-images:hover .experience-badge {
    ...
    <section class="best-blog-section"
        style="background: url('{{ asset('frontend/assets/bg_section_product_home_1-min.jpg') }}') no-repeat fixed center; background-size: cover; padding: 80px 0;">
        <div class="container">
            <div class="site-heading mb-0 text-center">
                ...
                <h2 class="site-title">
                    Nhà phân phối độc quyền của nhiều thương hiệu lớn trên thế giới
                </h2>
            </div>

            <div class="home-banner-triple section-distance index-scss ">
                <div class="row">
                    @foreach ($home_news as $key => $item)
                        <div class="col-md-6 col-sm-12 mb-4">
                            <div class="home-banner-triple-item-container">
                                <img src="{{ $item->image }}" alt="">
                                <div class="hover-info">
                                    <div class="hover-content">
                                        <h3 class="service-title">{{ languageName($item->title) }}</h3>
    ...
    <style>
        ...
        .site-title span {
            color: #ffd700;
            /* Ví dụ dùng màu vàng để nhấn mạnh “dịch vụ” */
        }
    ...
    <div class="home-banner-double section-distance" style='margin-top: 50px'>
        <div class="d-flex-vertical d-flex-center layout-gap-0.5unit  home-custom-header  ">
            <h2 class="m-reset f-size-5 f-superbold limit-line threeline f-center text-primary-color">Dự án của chúng tôi
            </h2>
            <div class='home-custom-header-flex'>
            </div>
            <div class="home-custom-header-flex d-flex-vertical d-flex-center">
                <a class="m-reset f-size-3 limit-line fiveline f-center home-custom-extra-header" href="#"
                    title="Xem tất cả ">Xem tất cả</a>
            </div>
        </div>
                ...
                <div class="home-banner-double-item-container">
                    ...
                    <div class="slide-content">
                        ...
                        <div class="btn-wrapper">
                            <a href="{{ route('duanTieuBieuDetail', $item->slug) }}" class="btn-detail">
                                Chi Tiết
                            </a>
                        </div>
                    </div>
        ...
        <style>
            /* Slider chính */
            .home-banner-double-slider .owl-stage {
                display: flex;
            }
            ...
            .home-banner-double-slider .owl-nav .owl-prev {
                left: 1%;
            }

            .home-banner-double-slider .owl-nav .owl-next {
                right: 1%;
            }
    ...
    <section class="home-blog section-distance">
        <div class="container">
            <div class="home-blog-wrap">
                <div class="d-flex-vertical d-flex-center layout-gap-0.5unit  home-custom-header">
                    <h2 class="m-reset f-size-5 f-superbold limit-line threeline f-center text-primary-color">Giải pháp của
                        chúng tôi</h2>
                </div>
                            ...
                            <div class="home-blog-item">
                                <div class="article-item " data-index="2">
                                    <div class="article-item-wrap">
                                        <a href="{{ route('detailBlog', $item->slug) }}" class="article-item-image"
                                        ...
                                        <div class="article-item-detail">
                                            ...
                                            <a title="Xem thêm" href="{{ route('detailBlog', $item->slug) }}"
        ...
        <section class="home-banner-lg section-distance">
            ...
            <div class="home-banner-lg-wrapper">
                <div class="home-banner-lg-container animate need-cover-bg fade-black-bg">
                    <a href="{{ $bannerAd->link }}" aria-label="F1 Fashion Style" title="F1 Fashion Style"
                        class="">
                        <picture>
                            <source width="1920" height="960" media="(min-width: 800px)"
                                srcset="{{ $bannerAd->image }}">
                            <source width="800" height="800" media="(min-width: 0)"
                                srcset="{{ $bannerAd->image }}">
                            <img class="" loading="lazy" decoding="async" fetchpriority="low" width="1920"
                                height="960" src="{{ $bannerAd->image }}" alt="F1 Fashion Style"
                                title="F1 Fashion Style">
                        </picture>
                    </a>
                    <div class="home-banner-lg-item d-flex d-flex-center d-flex-vertical layout-gap-2unit">
                        ...
                        <a href="{{ $bannerAd->link }}" title="Khám phá ngay "
                            class="home-banner-lg-button primary-btn">
    ...
    <section class="feedback-section">
        <div class="feedback-container">
            ...
            <div class="feedback-header">
                <span class="feedback-tagline"><i class="fa fa-comments"></i> Đánh giá</span>
                <h2 class="feedback-title">
                    Khách Hàng Nói Gì Về <span>{{ $setting->company }}</span>
                </h2>
                <p class="feedback-subtitle">
                    Luôn đặt khách hàng làm trọng tâm, hiểu rõ nhu cầu của họ và cung cấp các dịch vụ vượt xa mong đợi, đảm
                            ...
                            <a aria-label="" title="" class="">
                                <picture>
                                    <img class="" loading="lazy" decoding="async" fetchpriority="low"
                                        width="480" height="320" src="{{ $item->image }}" alt=""
                                        title="">
                                </picture>
                            </a>
                        </div>
