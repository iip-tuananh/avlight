            ...
            <div class="container">
                <div class="breadcrumb-wrap">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><span>{{ $title_page }}</span></li>
                    </ol>
                </div>		</div>
        </div>
        <div class="container">
            <div class="main-blog-wrap">
                ...
                @if (count($blog) > 0)
                    <div class="main-blog-left">
                        <h3 class="related-title">{{ $title_page }}</h3>
                                ...
                                <div class="article-item " data-index="">
                                    <div class="article-item-wrap">
                                        ...
                                        <div class="article-item-detail">
                                            <h3 class="article-item-detail-title"><a title="{{ $item->name }}" href="{{ route('detailBlog', ['slug' => $item->slug]) }}">
                                                    {{ $item->name }}</a></h3>
                                            ...
                                            <a title="Xem thêm" href="{{ route('detailBlog', ['slug' => $item->slug]) }}" class="article-item-detail-more" >Xem thêm</a>
